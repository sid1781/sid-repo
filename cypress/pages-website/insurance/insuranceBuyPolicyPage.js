...
export class InsuranceBuyPolicyPage {
    ...
    elements = {
        iframeInsuance: () => cy.get('[data-cy="insurance"]', { timeout: 9000 }),
        ...
        lblBuyPolicyCard1OneTimePremium: () => cy.get('[]'),
        valBuyPolicyCard1OneTimePremium: () => cy.get('[]'),
        ...
        lblIAgreeToTermsAndConditions: () => cy.getIframeBody().contains('I agree to '),
    ...
    enterDOB(DOB) {
        this.elements.inpDOB().type(DOB)
    }

    enterNomineeName(NomineeName) {
        this.elements.inpNomineeName().type(NomineeName)
    }

    enterPhoneNumber(PhoneNumber) {
        this.elements.inpPhoneNumber().type(PhoneNumber)
    }
    ...
    clickIAgreeToTermsAndConditionsCheckbox() {
        this.elements.chkBoxIAgreeToTermsAndConditions().click()
    }
    ...
    verifyIAgreeToTermsAndConditionsCheckbox(label) {
        this.elements.chkBoxIAgreeToTermsAndConditions().should('have.text', label)
    }
    verifyInfoAlreadyPurchasedText(alreadyPurchased) {
        this.elements.txtInfo().should('have.text', alreadyPurchased)
    }
    clickGetNowButton() {
