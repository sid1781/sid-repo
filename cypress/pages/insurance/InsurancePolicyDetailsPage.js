...
export class InsurancePolicyDetailsPage {
    ...
    elements ={   
        ...
        txtViewAll : () => cy.get('[]'),
        lnkTermsAndCondtions : () => cy.getIframeBody().contains('span','Terms & Conditions').eq(0),
        ...
        lblInsuranceName: () => cy.getIframeBody().contains('p','Personal Accident + Hospicash (Reimbursement of Rs. 1000 per day)'),
