...
describe('spec 2', { retries: 1 }, () => {
    it('login2', () => {
        ...
        var payload = { "query": "SELECT otp from `yp_user_otp` WHERE `sentTo` ='9611496051' order by id desc limit 1", "db_ip": "10.105.60.161" };
        cy.log(payload)
        cy.wait(3000)
